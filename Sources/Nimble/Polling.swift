...
///
/// Note: This has been renamed to ``PollingDefaults``.
...
extension SyncExpectation {
    ...
    public func toEventually(_ predicate: Predicate<Value>, timeout: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
    ...
    public func toEventuallyNot(_ predicate: Predicate<Value>, timeout: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
        nimblePrecondition(expression.isClosure, "NimbleInternalError", toEventuallyRequiresClosureError.stringValue)
    ...
    public func toNotEventually(_ predicate: Predicate<Value>, timeout: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
    ...
    public func toNever(_ predicate: Predicate<Value>, until: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
        nimblePrecondition(expression.isClosure, "NimbleInternalError", toEventuallyRequiresClosureError.stringValue)
    ...
    public func neverTo(_ predicate: Predicate<Value>, until: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
    ...
    public func toAlways(_ predicate: Predicate<Value>, until: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
        nimblePrecondition(expression.isClosure, "NimbleInternalError", toEventuallyRequiresClosureError.stringValue)
    ...
    public func alwaysTo(_ predicate: Predicate<Value>, until: DispatchTimeInterval = PollingDefaults.timeout, pollInterval: DispatchTimeInterval = PollingDefaults.pollInterval, description: String? = nil) -> Self {
